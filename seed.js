...
db.serialize(()=>{
	...
	const createTableCharacters = 'CREATE TABLE IF NOT EXISTS characters (character_name TEXT, class_name_id INTEGER)'
	const createTableClasses = 'CREATE TABLE IF NOT EXISTS classes (class_name TEXT UNIQUE)'
	const createTableWeapons = 'CREATE TABLE IF NOT EXISTS weapons (weapon_name TEXT UNIQUE, isRanged INTEGER, isMelee INTEGER, isMagic INTEGER)'
	...
	const insertIntoCharacters = 'INSERT INTO characters (character_name, class_name_id) VALUES (?, ?)'
	const insertIntoClasses = 'INSERT INTO classes (class_name) VALUES (?)'
	const insertIntoWeapons = 'INSERT INTO weapons (weapon_name, isRanged, isMelee, isMagic) VALUES (?, ?, ?, ?)'
