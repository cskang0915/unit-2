...
db.serialize(()=>{
	...
	const createTableClasses = 'CREATE TABLE IF NOT EXISTS classes (name TEXT UNIQUE)'
	const createTableWeapons = 'CREATE TABLE IF NOT EXISTS weapons (name TEXT UNIQUE, isRanged INTEGER, isMelee INTEGER, isMagic INTEGER)'
